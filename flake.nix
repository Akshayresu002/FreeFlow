{
  description = "FreeFlow - A free, open source, and extensible speech-to-text application that works completely offline";
        ...
        in
        {
          handy = pkgs.rustPlatform.buildRustPackage {
            ...
            meta = {
              ...
              homepage = "https://github.com/freeflow/app";
      ...
      devShells = forAllSystems (
        ...
        in
        {
          default = pkgs.mkShell {
            ...
            shellHook = ''
              echo "FreeFlow development environment"
              bun install
