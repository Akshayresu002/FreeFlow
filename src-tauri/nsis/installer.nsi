; Custom NSIS template for FreeFlow with portable mode support.
...
Function PageLeaveInstallType
  ...
  ${If} $0 = ${BST_CHECKED}
    ...
    ; --- PORTABLE MODE --- Switch default directory to Desktop\FreeFlow for portable
...
Function .onInit
  ...
  ; or the legacy empty marker created by older FreeFlow releases. Require Data/
...
Section Install
  ...
  ${If} $PortableMode = 1
    ...
    FileWrite $0 "FreeFlow Portable Mode"
    FileClose $0
