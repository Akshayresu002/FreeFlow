...
import { FreeFlowKeysShortcutInput } from "./FreeFlowKeysShortcutInput";
 ...
 * - "handy_keys": Uses FreeFlowKeysShortcutInput with backend key events
 */
export const ShortcutInput: React.FC<ShortcutInputProps> = (props) => {
  ...
  if (keyboardImplementation === "handy_keys") {
    return <FreeFlowKeysShortcutInput {...props} />;
  }
